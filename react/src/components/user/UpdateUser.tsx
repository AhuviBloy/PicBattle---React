...
//הצגת מודל עדכון פרטים אישיים של משתמש

// import { Box, Button, Modal, TextField, Typography, IconButton, Avatar, Fade } from "@mui/material";
...
//         `https://localhost:7143/api/User/${userId}`,
//         {
...
//           setEmailError("גישה לא מורשית");
//         } else {
//           setEmailError("שגיאה לא ידועה");
//         }
//       }
//     } finally {
//       setLoading(false);
...
//   return (
//     <>
//       <Box sx={{ position: "flex", top: "100פס", left: 0, marginLeft: "120px", marginTop: "20px" }}>
//         <Button
//           variant="outlined"
//           onClick={() => {
//             setOpen(true);
...
//                 }}
//               >
//                 ניתן לעדכן את הפרטים האישיים שלך
//               </Typography>
//             </Box>
